...
Blockly.JS["stock_buy_simple"] = function (block) {
  var number_id = block.getFieldValue("ID");
  var number_amount = block.getFieldValue("Amount");
  var number_price = block.getFieldValue("Price");
  var value_number = Blockly.JS.valueToCode(
    block,
    "Number",
    Blockly.JS.ORDER_ATOMIC
  );
...
Blockly.JS["stock_buy_prog"] = function (block) {
  var value_number = Blockly.JS.valueToCode(
    block,
    "Number",
    Blockly.JS.ORDER_ATOMIC
  );
  var value_name = Blockly.JS.valueToCode(
    block,
    "NAME",
    Blockly.JS.ORDER_ATOMIC
  );
...
Blockly.JS["stock_fetch_price"] = function (block) {
  var value_fetch = Blockly.JS.valueToCode(
    block,
    "Fetch",
    Blockly.JS.ORDER_ATOMIC
  );
  var variable_variable = Blockly.JS.nameDB_.getName(
